...
Files include readme, code, and data folders. Data files contain data sets collected by the North Campus Open Space at UCSB. Code files contain template code and code for the elective output.
...
![Invert Spiral Plot](invert_spiral_plot.png)