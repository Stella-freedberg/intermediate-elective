...
ggplot(data = invert_spiral) +
  ...
  # add title 
  labs(
    title = "Total abundance of the most common 
    inverts at NCOS in 2024"
  ) +
...
scale_color_manual(values = c(
  "Nematode" = "#eaafa6",
  "Hemiptera Corixidae Boatman" = "#9da0b0",
  "Cladocera" = "#c4a58f",
  "Copepod" = "#ecb025",
  "Ostracod" = "#dc354a"
))
...
- In order to use someone elses code as a visualization I first ran through their example to try to see what each chunk of code did. I then made a data frame that had the same lay out as the original code. Using this data frame I replaced all of the codes specific to the old data frame with the new code I had made.
